...
public class UserSegmentController {
    ...
    public ResponseEntity<UserSegmentResponse> addUserToSegment(@PathVariable Integer userId,
    ...
    public ResponseEntity<List<UserSegmentResponse>> getSegmentsByUser(@PathVariable Integer userId) {
    ...
    public ResponseEntity<List<UserSegmentResponse>> getUsersBySegment(@PathVariable Integer segmentId) {
